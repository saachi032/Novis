      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="relative overflow-hidden rounded-3xl border border-brand-gray/70 bg-white dark:bg-neutral-900 p-8 shadow-card sm:p-12 lg:p-16">
          ...
          <div className="relative grid gap-10 lg:grid-cols-12 lg:items-end lg:gap-12">
            <div className="order-2 max-w-md lg:order-1 lg:col-span-4">
              <p className="text-pretty text-sm leading-relaxed text-neutral-600 sm:text-base">
                Novis is an on-chain robo-advisor for USDC on Base Sepolia:
                deposit once, set your risk profile, and the vault routes liquidity
                across Aave v3 and Compound v3 — non-custodial and ERC-4626 aligned.
              </p>
          ...
          <div className="relative mt-12 flex flex-wrap gap-3 border-t border-brand-gray/50 pt-8">
            {["Base Sepolia", "USDC", "Aave v3", "Compound v3", "ERC-4626"].map((name) => (
              <span
                key={name}
